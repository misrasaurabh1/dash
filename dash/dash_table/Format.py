...
class Format:
    ...
    def to_plotly_json(self):
        # Optimization: prefetch _specifier, compute aligned once,
        # and concatenate strings using + for best performance.
        f = {}
        ...
        aligned = spec["align"] != Align.default

        # Directly concatenate all string parts for better performance
        fill = spec["fill"] if aligned else ""
        f["specifier"] = (
            fill
            + spec["align"]
            + spec["sign"]
