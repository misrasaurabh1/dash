...
class Format:
    def __init__(self, **kwargs):
        ...
        # Use a set for O(1) valid method checks
        valid_methods = {
    ...
    def _validate_char(self, value):
        # Inline and optimize for performance to avoid extra python call
    ...
    def group_delimiter(self, value):
        # Hot path optimization: local method ref not needed due to inlining
        self._validate_char(value)
